...
\hypersetup{pdftitle={Языки программирования}, pdfauthor={И. О. Фамилия}} % ПОМЕНЯТЬ pdftitle, pdfauthor
...
\begin{abstract}
	Этот документ демонстрирует класс документа mirea-prog-lang, соответствующий у\-чеб\-но-ме\-то\-ди\-чес\-ко\-му пособию~\cite{bib:recomendations}, разделу 3, скомпилированный системой компьютерной вёрстки X\makebox[1.7mm]{\raisebox{-1.1mm}{\reflectbox{E}}}\LaTeX. 
...
\noindent\verb"\documentclass{mirea-prog-lang}"\\\\
\verb"\usepackage{hyperref}"\\
\verb"\hypersetup{pdftitle={"Языки программирования\verb"},"\\\hspace*{3cm}\verb"pdfauthor={"И. О. Фамилия\verb"},"\\\hspace*{3cm}\verb"colorlinks=false,"\\\hspace*{3cm}\verb"pdfborder={0 0 0}}"\\
\verb"\begin{document}"\\
\hspace*{1cm}\verb"\begin{titlepage}"\\
\hspace*{2cm}\verb"..."\\
\hspace*{1cm}\verb"\end{titlepage}"\\
\hspace*{1cm}\verb"\begin{abstract}"\\
\hspace*{2cm}\verb"..."\\
\hspace*{1cm}\verb"\end{abstract}"\\\\
\hspace*{1cm}\verb"\tableofcontents"\\\\
\hspace*{1cm}\verb"\section*{"Введение\verb"}"\\
\hspace*{1cm}\verb"\phantomsection"\\
\hspace*{1cm}\verb"\addcontentsline{toc}{section}{"Введение\verb"}"\\
\hspace*{1cm}\verb"..."\\\\
\hspace*{1cm}\verb"\section{...}"\\
\hspace*{1cm}\verb"..."\\\\
\hspace*{1cm}\verb"\appendix"\\
\hspace*{1cm}\verb"\section{...}"\\
\hspace*{1cm}\verb"..."\\
\verb"\end{document}"
