...
\begin{abstract}
	Этот документ демонстрирует класс документа mirea-prog-lang, соответствующий у\-чеб\-но-ме\-то\-ди\-чес\-ко\-му пособию~\cite{bib:recomendations}, разделу 3, скомпилированный системой компьютерной вёрстки X\raisebox{-1mm}{\reflectbox{E}}\LaTeX. 
	...
	Шаблон .tex не~может быть экспортирован в~.doc (.docx).
	
	\subsection*{Пакет hyperref}
	
	Чтобы сделать интерактивные ссылки и добавить метаданные документа необходимо включить пакет hyperref в~Ваш документ. Пример:\\
	\verb"\usepackage{hyperref}"\\
	\verb"\hypersetup{pdftitle={"Языки программирования\verb"},"\\\hspace*{3cm}\verb"pdfauthor={"В. С. Верхотуров\verb"},"\\\hspace*{3cm}\verb"colorlinks=false,"\\\hspace*{3cm}\verb"pdfborder={0 0 0}}"
