...
\apptocmd{\appendix}{
    ...
    \renewcommand{\section}{
        ...
        \setcounter{figure}{0} % Счёт иллюстраций в пределах иллюстрации
        \setcounter{table}{0} % Счёт таблиц в пределах таблицы
        \setcounter{equation}{0} % Счёт иллюстраций в пределах иллюстрации
...
\subsubsection{Сложное перечисление}
